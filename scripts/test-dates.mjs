...
import { isFutureLocalSlot, shiftDate, zonedInstant } from '../lib/dates.mjs';
...
assert.equal(isFutureLocalSlot('2026-09-23T09:30','America/Sao_Paulo',new Date('2026-09-23T12:29:59Z')),true);
assert.equal(isFutureLocalSlot('2026-09-23T09:30','America/Sao_Paulo',new Date('2026-09-23T12:30:00Z')),false);
console.log('8 verificações de datas passaram.');
